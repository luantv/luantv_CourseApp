	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<h2 class="page-header">Upload profile image</h2>

				<div class="row placeholders">
					<div class="col-md-2 col-sm-2">
						<img class="img-responsive img-hover"
							src="<c:out value="profile_image/${currentUser.userID }" default="http://placehold.it/150x150" />"
							alt="..." style="height: 150px; display: block;">
					</div>
					<div class="col-md-10 col-sm-10">
						<form action="upload_profile_img" method="POST"
							enctype="multipart/form-data" class="form-horizontal"
							id="uploadImageForm">
							<div class="form-group">
								<label for="fileUpload" class="col-md-3 col-sm-3 control-label"> Select file to upload:
								</label>
