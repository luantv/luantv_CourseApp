				...
				<div class="row">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-book"></i> All Users</li>
						</ol>
						<h2>All Users</h2>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
							<ul class="list-inline">
								<li class="label label-primary">All</li>
									...
									<c:forEach begin="1" end="${pageCount }" var="item">
										<c:choose>
											<c:when test="${numPage eq item }">
												<li class="active"><a
													href="list_account?numPage=${item }">${item }</a></li>
											</c:when>
											<c:otherwise>
												<li><a href="list_account?numPage=${item }">${item }</a></li>
											</c:otherwise>
										</c:choose>

									</c:forEach>
									<li><a href="list_account?numPage=${pageCount }"
