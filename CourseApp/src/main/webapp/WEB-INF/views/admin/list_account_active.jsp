				...
				<div class="row">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li><a href="list_account"><i class="fa fa-home"></i> Courses</a></li>
							<li class="active"><i class="fa fa-book"></i> Active accounts</li>
						</ol>
				...
				<div class="row">
					<div class="col-md-6">
							<ul class="list-inline">
								<li><a href="list_account">All</a></li>
								<li><a href="list_account_admin">Administrator</a></li>
								...
								<li class="label label-primary">Active</li>
								<li><a href="list_account_blocked">Blocked</a></li>
							</ul>
						</div>
						<div class="col-md-6">
						...
						<table class="table table-hover table-bordered"
								...
								<thead>
									<tr>
										...
										<!-- <th>Create date</th>
										<th>Tags</th>
										<th class="hide">curriculum</th>
										<th class="hide">objectives</th>
										<th class="hide">description</th>
										<th class="hide">requirements</th>
								...
								<c:forEach begin="1" end="${pageCount }" var="item">
									<c:choose>
										<c:when test="${numPage eq item }">
											<li class="active"><a
												href="list_account_active?numPage=${item }">${item }</a></li>
										</c:when>
										<c:otherwise>
											<li><a href="list_account_active?numPage=${item }">${item }</a></li>
										</c:otherwise>
									</c:choose>

								</c:forEach>
								<li><a href="list_account_active?numPage=${pageCount }"
