				...
				<div class="row">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-book"></i> Blocked accounts</li>
						</ol>
				...
				<div class="row">
					<div class="col-md-6">
							<ul class="list-inline">
								...
								<li class="label label-primary">Blocked</li>
							</ul>
						</div>
						<div class="col-md-6">
									...
									<c:forEach begin="1" end="${pageCount }" var="item">
										<c:choose>
											<c:when test="${numPage eq item }">
												<li class="active"><a
													href="list_account_blocked?numPage=${item }">${item }</a></li>
											</c:when>
											<c:otherwise>
												<li><a href="list_account_blocked?numPage=${item }">${item }</a></li>
											</c:otherwise>
										</c:choose>

									</c:forEach>
									<li><a href="list_account_blocked?numPage=${pageCount }"
