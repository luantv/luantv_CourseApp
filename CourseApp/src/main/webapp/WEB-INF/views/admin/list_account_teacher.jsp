...
<head>
<title>Admin: Teacher Users</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-book"></i> Teacher Users</li>
						</ol>
						<h2>Teacher Users</h2>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
							<ul class="list-inline">
								...
								<li  class="label label-primary">Teacher</li>
									...
									<c:forEach begin="1" end="${pageCount }" var="item">
										<c:choose>
											<c:when test="${numPage eq item }">
												<li class="active"><a
													href="list_account_teacher?numPage=${item }">${item }</a></li>
											</c:when>
											<c:otherwise>
												<li><a href="list_account_teacher?numPage=${item }">${item }</a></li>
											</c:otherwise>
										</c:choose>

									</c:forEach>
									<li><a href="list_account_teacher?numPage=${pageCount }"
